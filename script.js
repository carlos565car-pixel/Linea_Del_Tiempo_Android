const versions = [
    {
        ...
        Incluyó soporte para múltiples cuentas de Google, Google Maps Navigation gratis,
        teclado virtual mejorado, Bluetooth 2.1, cámara con flash, zoom digital y soporte HTML5.
        Fue importante porque marcó el inicio de Android como un sistema competitivo.
        `
    },
    {
        id: "android3",
        ...
        barra de acciones superior, multitarea visual, widgets redimensionables
        y aceleración gráfica por hardware.
        Google quería competir con el iPad con esta versión.
        `
    },
    {
        id: "android4",
        ...
        nuevas notificaciones, control del uso de datos y navegador mejorado.
        Fue una de las versiones más importantes del diseño moderno de Android.
        `
    },
    {
        id: "android5",
        ...
        Incluyó notificaciones en pantalla de bloqueo, Project Volta para batería,
        modo multiusuario en teléfonos y soporte para Android TV y Wear.
        `
    },
    {
        id: "android6",
        ...
        y USB Type-C. Mejoró mucho la seguridad y el control del usuario.
        `
    },
    {
        id: "android7",
        ...
        soporte Vulkan API para juegos y mejoras de rendimiento.
        `
    },
    {
        id: "android8",
        ...
        mejoras de batería y límites de procesos en segundo plano.
        `
    },
    {
        id: "android9",
        ...
        y protección contra apps en segundo plano abusivas.
        `
    },
    {
        id: "android10",
        ...
        Live Caption, mejoras de privacidad, control de ubicación
        y soporte para pantallas plegables.
        `
    },
    {
        id: "android11",
    ...
    },
    {
        ...
        widgets rediseñados y nuevas animaciones.
        `
    },
    {
        id: "android13",
        ...
        mejoras de seguridad y personalización avanzada.
        `
    },
    {
        id: "android14",
        ...
        y nuevas APIs para desarrolladores y juegos.
        `
    },
    {
        id: "android15",
        ...
        mejoras en gaming y optimización del sistema.
        Es una versión orientada al futuro de Android.
        `
    }
];
...
function openModal(id) {
    ...
    document.getElementById("modal-content").innerHTML = `
        <img src="${v.img}" style="width: 60px; margin-bottom: 10px;">
        <h2>${v.name}</h2>
        <p>${v.desc}</p>
    `;
