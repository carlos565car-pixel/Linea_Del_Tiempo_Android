const versions = [
    {
        ...
        * **Transiciones Animadas:** Por primera vez, el sistema incluía animaciones al abrir y cerrar aplicaciones, dando una sensación de fluidez que alejaba a Android de su imagen "robótica" inicial.
        `
    },
    {
        id: "android1_6",
        ...
        * **Soporte para CDMA:** Esta adición técnica permitió que Android llegara a operadoras como Verizon en EE.UU., lo que disparó las ventas de dispositivos como el Motorola Droid.
        `
    },
    {
        id: "android2_0",
        ...
        * **Teclado Mejorado:** Se optimizó la velocidad de escritura y se añadió soporte para multitáctil, permitiendo escribir mucho más rápido que en versiones anteriores.
        `
    },
    {
        id: "android2_2",
        ...
        * **Actualizaciones Automáticas del Market:** Se añadió la opción para que las aplicaciones se actualizaran solas en segundo plano, asegurando que el usuario siempre tuviera la última versión sin esfuerzo.
        `
    },
    {
        id: "android2_3",
        ...
        * **Descargas Centralizadas:** Añadió un administrador de descargas unificado para que el usuario pudiera encontrar fácilmente cualquier archivo bajado desde el navegador o el correo.
        `
    },
    {
        id: "android3_0",
        ...
        * **Navegador con Pestañas:** El navegador nativo pasó a tener pestañas reales como las de un PC, además de un modo incógnito y sincronización con los marcadores de Chrome en el escritorio.
        `
    },
    {
        id: "android4_0",
        ...
        * **Face Unlock:** Android introdujo el reconocimiento facial experimental en 2011, permitiendo desbloquear el teléfono simplemente mirando a la cámara frontal.
        `
    },
    {
        id: "android4_1",
        ...
        * **Project Butter (V-Sync):** Implementó el triple buffering en la cadena de gráficos y aumentó la potencia de la CPU en el momento exacto en que el dedo tocaba la pantalla para garantizar una respuesta instantánea.
        ...
        * **Ajuste Automático de Widgets:** Los iconos y widgets en la pantalla de inicio empezaron a moverse y cambiar de tamaño automáticamente para dejar espacio a nuevos elementos.
        `
    },
    {
        id: "android4_4",
        ...
        * **Selector de Archivos Unificado:** Introdujo una interfaz común para abrir archivos desde Google Drive, la memoria interna o la tarjeta SD de forma transparente para las aplicaciones.
        `
    },
    {
        id: "android5_0",
        ...
        * **Cuentas de Invitado:** Permitió crear múltiples perfiles de usuario en un mismo teléfono, ideal para prestar el móvil sin que otras personas vieran fotos o correos privados.
        `
    },
    {
        id: "android6_0",
        ...
        * **Adoptable Storage:** Permitió formatear una tarjeta SD para que el sistema la tratara como parte de la memoria interna, solucionando de forma definitiva el problema de espacio en móviles económicos.
        `
    },
    {
        id: "android7_0",
        ...
        * **Ahorro de Datos:** Introdujo un interruptor global para evitar que las aplicaciones consumieran datos móviles en segundo plano, ideal para viajes o planes limitados.
        `
    },
    {
        id: "android8_0",
        ...
        * **Iconos Adaptativos:** Estandarizó la forma de los iconos para que todos los desarrolladores pudieran ofrecer iconos redondos, cuadrados o con formas personalizadas según el tema del fabricante.
        `
    },
    {
        id: "android9_0",
        ...
        * **Brillo Adaptativo:** Dejó de usar solo el sensor de luz para aprender de tus ajustes manuales en diferentes entornos, ajustando la luz de forma personalizada para cada usuario.
        `
    },
    {
        id: "android10",
        ...
        * **Smart Reply en Notificaciones:** El sistema empezó a sugerir respuestas inteligentes y acciones (como abrir Maps si hay una dirección) para cualquier aplicación de mensajería de forma automática.
        `
    },
    {
        id: "android11",
        ...
        * **Permisos de un Solo Uso:** Añadió la capacidad de dar acceso al micro o cámara solo "esta vez", revocando el permiso automáticamente al cerrar la aplicación por razones de privacidad extrema.
        `
    },
    {
        id: "android12",
        ...
        desc: `
        Lanzada en octubre de 2021, Android 12 trajo "Material You", el cambio visual más ambicioso desde 2014. Google decidió que el usuario debía ser el diseñador de su propio teléfono. Mediante un motor de extracción de color, el sistema operativo pasó a ser camaleónico, adaptándose al fondo de pantalla elegido por el usuario. Pero no todo fue estética; Android 12 introdujo un panel de privacidad radical que mostraba exactamente qué apps habían accedido a los datos del usuario en las últimas 24 horas. Fue una versión que equilibró la expresión personal extrema con una seguridad de grado militar, convirtiendo al smartphone en un dispositivo mucho más personal, vibrante y transparente para el usuario final.

        * **Material You y Motor de Temas Dinámicos:** El sistema analiza los colores de tu fondo de pantalla y crea una paleta de colores personalizada que se aplica a los relojes, botones, iconos de apps y menús de todo el sistema de forma mágica.
        * **Dashboard de Privacidad:** Un centro de control único que muestra una línea del tiempo de cada vez que una aplicación accedió a la cámara, el micrófono o la ubicación, permitiendo revocar permisos al instante de forma centralizada.
        * **Indicadores de Sensores en Vivo:** Añadió un punto verde brillante en la esquina de la pantalla para avisar en tiempo real si el micro o la cámara están activos, junto con interruptores globales en ajustes rápidos para apagar estos sensores por completo.
        * **Ubicación Aproximada:** Permitió a los usuarios dar a las apps de clima o noticias una ubicación "borrosa" en lugar de las coordenadas exactas de su casa, protegiendo su privacidad real.
        * **Capturas de Pantalla con Desplazamiento:** Finalmente integró de forma nativa la capacidad de capturar conversaciones largas o páginas web completas deslizando hacia abajo.
        `
    },
    {
        id: "android13",
        ...
        * **Selector de Fotos Privado:** En lugar de dar permiso a una aplicación para ver "toda tu galería", ahora puedes elegir compartir solo 2 o 3 fotos específicas mediante una interfaz segura del sistema que oculta el resto.
        * **Mejoras para Tablets:** Optimizó el diseño de las notificaciones en dos columnas y mejoró el arrastrar y soltar archivos entre aplicaciones abiertas al mismo tiempo.
        `
    },
    {
        id: "android14",
        ...
        desc: `
        Android 14, lanzada en octubre de 2023, se enfocó en la longevidad del hardware y en la expresión creativa. Con pantallas cada vez más brillantes y cámaras de nivel profesional, el sistema se optimizó para soportar Ultra HDR y para dar al usuario un control total sobre su pantalla de bloqueo. Pero lo más importante fue lo que sucedió "debajo": Google trabajó en reducir el consumo de las tareas en segundo plano para que los teléfonos duraran más tiempo encendidos. También introdujo mejoras masivas en accesibilidad, reconociendo que la tecnología debe ser usable por todos, integrando de forma nativa el soporte para audífonos avanzados y escalado de texto inteligente.

        * **Personalización de la Pantalla de Bloqueo:** Permitió cambiar las tipografías del reloj, los widgets y los accesos directos laterales, además de introducir fondos de pantalla generados por IA según el estado de ánimo del usuario.
        * **Soporte de Ultra HDR:** Permitió que las fotos capturadas con sensores modernos se mostraran con un rango dinámico real, haciendo que las luces brillen y las sombras tengan detalle sin perder fidelidad de color en pantallas compatibles.
        * **Health Connect Integrado:** Los datos de salud (pasos, sueño, calorías) se unificaron en el núcleo del sistema, permitiendo que apps como Fitbit, Strava y Google Fit compartan datos de forma privada y segura sin intermediarios.
        * **Escalado de Texto Inteligente:** Introdujo un escalado no lineal que permite que el texto pequeño crezca hasta un 200% sin que el texto que ya es grande se desborde o rompa el diseño visual de la aplicación.
        * **Flash de Notificaciones:** Una opción de accesibilidad que permite que el flash de la cámara o la pantalla parpadeen al recibir una alerta, ideal para personas con dificultades auditivas.
        `
    },
    {
        id: "android15",
        ...
        desc: `
        Android 15 representa el amanecer de la Inteligencia Artificial Generativa integrada en el ADN del dispositivo. Lanzada en 2025, esta versión ha dejado de ser un simple lanzador de aplicaciones para convertirse en un asistente personal proactivo impulsado por Gemini. Se enfoca en resolver los problemas de seguridad del mundo real, como el robo físico de dispositivos, y en ofrecer una privacidad extrema mediante compartimentos estancos dentro del software. Con Android 15, el teléfono es capaz de entender el contexto físico y digital del usuario, protegiéndolo de estafas en tiempo real y permitiendo una productividad multitarea que antes solo era posible en ordenadores de sobremesa profesionales.

        * **Espacio Privado (Private Space):** Crea un perfil de usuario paralelo y oculto donde puedes guardar aplicaciones bancarias o documentos confidenciales. Cuando se bloquea, estas apps desaparecen por completo de la multitarea y de la lista de apps, requiriendo una autenticación distinta.
        * **Detección de Robo por IA:** Utiliza los acelerómetros y modelos de IA para detectar el movimiento específico de alguien arrebatando el teléfono de la mano del usuario y corriendo. El sistema bloquea la pantalla instantáneamente antes de que el ladrón pueda acceder.
        * **Conectividad Satelital Nativa:** Permite enviar mensajes de texto y alertas de emergencia SOS mediante conexión directa a satélites cuando no hay cobertura de red terrestre o Wi-Fi, ideal para senderistas o emergencias en zonas remotas.
        * **Multitarea para Plegables y Tablets:** Introdujo la capacidad de anclar una barra de tareas permanente y de guardar "pares de aplicaciones" (por ejemplo, Gmail y Calendario) para abrirlos siempre juntos en pantalla dividida con un solo toque rápido.
        * **Archivado de Apps:** Permite liberar hasta un 60% de espacio eliminando la app pero manteniendo tus datos y documentos, permitiendo reinstalarla después sin perder nada de tu configuración.
        `
    }
];
...
function openModal(id) {
    ...
    // Formatear texto: saltos de línea a <br> y viñetas a <li>
    ...
    document.getElementById("modal-content").innerHTML = `
        <img src="${v.img}" style="width: 100px; display: block; margin: 0 auto 20px;">
    ...
    // Resetear el scroll del contenido al abrir un nuevo modal
